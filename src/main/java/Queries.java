public class Queries {
    ...
    public static String QUERY_1 = "SELECT REGION, \n" +
            ...
            "FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bloomberg.BLOOMBERG_TZERO_OUT \n" +
            "WHERE  REGION = ? \n" +
            "       AND DDATE = ?";
    ...
    public static String QUERY_2 = "SELECT TICKER, \n" +
            "       LAST_PRICE, \n" +
            "       DBTIMESTAMP \n" +
            "FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bpipe_rt.REAL_TIME T1 \n" +
            "WHERE  TICKER LIKE '%CURNCY%' \n" +
            "       AND DATA_RECEIVED_TIMESTAMP = (SELECT MAX(DATA_RECEIVED_TIMESTAMP) \n" +
            "                                      FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bpipe_rt.REAL_TIME T2 \n" +
    ...
    public static String QUERY_3 = "SELECT COUNTRY, \n" +
            ...
            "       AMT_OUTSTANDING, \n" +
            "       SECURITY_TYP \n" +
            "FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bloomberg_fi.CORP_PFD_OUT \n" +
            "WHERE  REGION = ? \n" +
            "       AND DATA_DATE = ? \n" +
    ...
    public static String QUERY_4 = "SELECT *\n" +
            ...
            "        FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bpipe_rt.REAL_TIME_FUTURES AS X\n" +
            "               INNER JOIN (SELECT TICKER,\n" +
            "                                  MAX(DATA_RECEIVED_TIMESTAMP) AS MAX_TIMESTAMP\n" +
            "                           FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bpipe_rt.REAL_TIME_FUTURES\n" +
            ...
            "                         X.CURRENCY_CODE,\n" +
            "                         X.DDATE AS FX_DATE\n" +
            "                  FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.barra.BARRA_FX_RATES_WITH_MINOR_CURRENCIES AS X\n" +
            "                         INNER JOIN\n" +
            "                         (SELECT CURRENCY_CODE,\n" +
            "                                 MAX(DDATE) AS DDATE\n" +
            "                          FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.barra.BARRA_FX_RATES_WITH_MINOR_CURRENCIES\n" +
    ...
    public static String QUERY_5 = "SELECT REPLACE(X.PARSEKYABLE_DES_SOURCE, ' ELEC ', ' ') AS TICKER, \n" +
            ...
            "FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bloomberg_futures.SHARE_FUTURES_PRICING_RPX AS X \n" +
            "       INNER JOIN (SELECT PARSEKYABLE_DES_SOURCE, \n" +
            "                          MAX(DBTIMESTAMP) AS MAX_TIMESTAMP \n" +
            "                   FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bloomberg_futures.SHARE_FUTURES_PRICING_RPX \n" +
    ...
    public static String QUERY_6 = "SELECT BTZ.FLEX_ID, \n" +
            "       BADJ.CLOSE_PX_ADJ \n" +
            "FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bloomberg.BLOOMBERG_TZERO_OUT BTZ, \n" +
            "       com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bloomberg.BLOOMBERG_TZERO_PX_OUT_ADJUSTED BADJ \n" +
            "WHERE  BTZ.REGION = ? \n" +
            "       AND BTZ.DDATE = ? \n" +
    ...
    public static String QUERY_7 = "SELECT M.TICKER, \n" +
            ...
            "        FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bpipe_rt.REAL_TIME AS X \n" +
            "               INNER JOIN (SELECT TICKER, \n" +
            "                                  MAX(DATA_RECEIVED_TIMESTAMP) AS MAX_TIMESTAMP \n" +
            "                           FROM   com.gigaspaces.test.database.jdbc.aquarious_poc.generator.model.bpipe_rt.REAL_TIME \n" +
